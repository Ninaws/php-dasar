			...
			<div class="sticky">
				<aside class="app-sidebar sidebar-scroll">
					...
					<div class="main-sidemenu">
						...
						<ul class="side-menu ">
							<li class="slide">
								 <a class="side-menu__item" href="../Array/array.php"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">Array</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							...
							<li class="slide">
							     <a class="side-menu__item" href="../Kondisi/if-elseif-else.php"><i class="side-menu__icon fe fe-layers"></i><span class="side-menu__label">Kondisi</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							     <a class="side-menu__item" href="../Kontrol_program/if_else.php"><i class="side-menu__icon fe fe-package"></i><span class="side-menu__label">Kontrol_program</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							     <a class="side-menu__item" href="../Perulangan/perulangan.php"><i class="side-menu__icon fe fe-file"></i><span class="side-menu__label">Perulangan</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
						 	<li class="slide">
							...
							<li class="slide">
							     <a class="side-menu__item" href="../Operator/Operator.php"><i class="side-menu__icon fe fe-compass"></i><span class="side-menu__label">Operator</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
						         <a class="side-menu__item" href="../Variabel/variabel.php"><i class="side-menu__icon fe fe-grid"></i><span class="side-menu__label">Variabel</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							     <a class="side-menu__item" href="../Tipe_data/tipedata.php"><i class="side-menu__icon fe fe-shopping-cart"></i><span class="side-menu__label">Tipe_data</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
