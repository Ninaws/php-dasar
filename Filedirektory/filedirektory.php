			...
			<div class="sticky">
				<aside class="app-sidebar sidebar-scroll">
					...
					<div class="main-sidemenu">
						<div class="main-sidebar-loggedin">
							<div class="app-sidebar__user">
								<div class="dropdown user-pro-body text-center">
										...
										<img src="1.jpeg" alt="user-img" class="rounded-5 wd-150 mCS_img_loaded">
									
									<div class="user-info">
										<h6 class=" mb-0 text-dark">Petey Cruiser</h6>
										<span class="text-muted app-sidebar__user-name text-sm">NINA</span>
									</div>
								</div>
							</div>
						</div>
						...
						<ul class="side-menu ">
							<li class="slide">
							<a class="side-menu__item" href="../Array/array.php"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Array</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							     <a class="side-menu__item" href="../From/from.php"><i class="side-menu__icon fe fe-award"></i><span class="side-menu__label">From</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							     <a class="side-menu__item" href="../Kondisi/Kondisi.php"><i class="side-menu__icon fe fe-layers"></i><span class="side-menu__label">Kondisi</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							     <a class="side-menu__item" href="../Kontrol_program/Kontrol_program.php"><i class="side-menu__icon fe fe-package"></i><span class="side-menu__label">Kontrol_program</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							     <a class="side-menu__item" href="../Perulangan/perulangan.php"><i class="side-menu__icon fe fe-refresh-ccw"></i><span class="side-menu__label">Perulangan</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
						 	<li class="slide">
							     <a class="side-menu__item" href="../String/string.php"><i class="side-menu__icon fe fe-bar-chart-2"></i><span class="side-menu__label">String</span><i class="angle fe fe-chevron-down"></i></a>
                            </li>
                            <li class="slide">
							     <a class="side-menu__item" href="../Filedirektory/filedirektory.php"><i class="side-menu__icon fe fe-chrome"></i><span class="side-menu__label">Filedirektory</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							     <a class="side-menu__item" href="../Operator_Refisi/Operator.php"><i class="side-menu__icon fe fe-briefcase"></i><span class="side-menu__label">Operator</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
						         <a class="side-menu__item" href="../Variabel_Refisi/variabel.php"><i class="side-menu__icon fe fe-bookmark"></i><span class="side-menu__label">Variabel</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							     <a class="side-menu__item" href="../Tipe_data_Refisi/tipedata.php"><i class="side-menu__icon fe fe-file-text"></i><span class="side-menu__label">Tipe_data</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							     <a class="side-menu__item" href="../upload_file/newfileupload.php"><i class="side-menu__icon fe fe-download-cloud"></i><span class="side-menu__label">Upload_file</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
							     <a class="side-menu__item" href="../Akses_databases/databases.php"><i class="side-menu__icon fe fe-folder-minus"></i><span class="side-menu__label">Akses_databases</span><i class="angle fe fe-chevron-down"></i></a>
							</li>
							<li class="slide">
			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">Filedirektory</h4>
								...
								<div class="card overflow-hidden">
									<div class="card-body pb-3">
										...
										<div class="pengertian">
											<p>Ada beberapa fungsi yang dapat digunakan di PHP untuk manipulasi direktori:</p>
											<p>1.Fungsi mkdir() untuk membuat direktori;</p>
											<p>2.Fungsi scandir() untuk melihat isi direktori;</p>
											<p>3.Fungsi rmdir() untuk menghapus direktori;</p>
											<p>4.Fungsi rename() untuk mengubah nama direktori.</p>
									    </div>
										<div class="cara-membuat-direktory">
											<!-- <p>
											...
											<div>
												...
												<!-- <p>atau</p> -->
												<?php
													//  mkdir("./ini_direktori/contoh/saja", 0777, true) 
												?>
										...
										<div class="cara-melihat-isi-direktory">
											<?php
										...
										<div class="cara-menghapus-direktory">
										...
										<div class="mengubah-nama-direktory">
											...
											<?php
												// rename("petanikode", "“petani_kode_baru"); 
											?>
										</div>
						<!-- /row -->
