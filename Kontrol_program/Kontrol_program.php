			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">Kontrol_program</h4>
								...
								<div class="card overflow-hidden">
									<div class="card-body pb-3">
										...
										<?php
                                           ...
                                           if ($tahun <2009){
                                              echo "Semoga kamu panjang umur";
                                           } else {
                                              echo "Selamat nambah usianya!";
                                           }
                                          ?>
										  <br>
										  <br>
										...
										<br>
										<?php
												$total_hadiah = "200,000";
												if($total_hadiah > 150000){
													echo "Selamat kamu mendapatkan hadiah, berupa uang";
												}
												?>
										...
										<?php
												...
												case 3:
														...
														break;
														case 4:
														echo "Pelajaran Javascrip!</br>";
														break;
												case 5:
														echo "Pelajaran PHP";
														break;
												default:
														echo "sofware enginering";
												}
